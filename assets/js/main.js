...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (terminalInput) {
        ...
        const commands = {
            ...
            'projects': '1. S2SMFG (Procure to Ship ERP)<br>2. Direct-to-Printer Robot (PowerShell)<br>3. Asakai Dashboard (Real-time Analytics)<br>4. Logistics Driver App (Flutter)',
            'skills': 'PHP, Laravel, JavaScript, Alpine.js, SQL, PowerShell, Flutter, cPanel, REST API.',
            'contact': 'Email: emailanda@gmail.com<br>Location: Cikarang, Indonesia<br>Let\'s build something cool.',
        };
